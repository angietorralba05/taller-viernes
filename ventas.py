...
registrar_venta(cliente_id=2, producto_id=2, cantidad=5)
registrar_venta(cliente_id=3, producto_id=3, cantidad=1)
registrar_venta(cliente_id=1, producto_id=4, cantidad=3)
...
def reporte_ventas_detallado():
    ...
    print(f'{"ID":>3} {"Fecha":<12} {"Cliente":<18} {"Producto":<18} {"Cant":>4} {"Total":>12}')
    print('-' * 72)
    total_general = 0
    for v in ventas:
